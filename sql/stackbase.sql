...
--
-- Host: localhost    Database: stackunderflow
-- ------------------------------------------------------
...
DROP DATABASE IF EXISTS stackunderflow;
...
CREATE TABLE `posts` (
  ...
  `contestada` smallint(6) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `respuestas` (
  ...
  KEY `user_id` (`user_id`),
  KEY `idpost` (`idpost`),
  CONSTRAINT `respuestas_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `respuestas_ibfk_2` FOREIGN KEY (`idpost`) REFERENCES `posts` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `votos` (
  ...
  `votos` smallint(6) DEFAULT NULL,
  KEY `id_user` (`id_user`),
  KEY `id_respuesta` (`id_respuesta`),
  CONSTRAINT `votos_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`),
  CONSTRAINT `votos_ibfk_2` FOREIGN KEY (`id_respuesta`) REFERENCES `respuestas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-06 11:40:05
